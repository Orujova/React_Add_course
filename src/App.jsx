...
const courses = [
  ...
  },
  {
    ...
    image:
      "https://www.food-safety.com/ext/resources/Images/2023/Apr_May/Cyber-Img1-900.jpg?1681140266",
  },
  {
    id: 6,
    title: "Node.js",
  ...
  return (
    <div className="course">
      ...
      <p>
        ...
        doloremque quia, ipsam odio dolorum doloribus labore ducimus qui,
        pariatur nemo! Quo pariatur iure temporibus illum voluptatibus culpa
...
function App() {
  ...
  useEffect(() => {
    // Retrieve the course list from local storage
    const storedCourseList = localStorage.getItem("courseList");

    if (storedCourseList) {
      // Parse the JSON string and set it as the initial state
      setCourseList(JSON.parse(storedCourseList));
    }
  }, []);

  function handleAddCourse() {
    const randomIndex = Math.floor(Math.random() * courses.length);
    const newCourse = courses[randomIndex];

    // Update the course list state and store it in local storage
    setCourseList([...courseList, newCourse]);
    localStorage.setItem("courseList", JSON.stringify([...courseList, newCourse]));
  }
